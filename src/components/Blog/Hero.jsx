    ...
    <div className="container mx-auto px-4 relative z-10">
      ...
      >
        ...
        <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
          Découvrez nos articles sur l'éducation, la parentalité et le développement de l'enfant. 
          Des conseils d'experts pour accompagner votre enfant dans son épanouissement.
        </p>
      </motion.div>
    </div>
  </section>
